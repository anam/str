<%@ Page Title="Add Item" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="editcompany.aspx.cs" Inherits="Default2" %>
    ...
    <form id="AddItem" runat="server">
        ...
        <table class="AddItem">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtPassword" class="form-control" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
